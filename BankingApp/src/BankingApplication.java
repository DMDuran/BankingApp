...
public class BankingApplication {
	...
	class BankAccount {
		...
		void getPreviousTransaction() {
			...
			{
				System.out.println("Withdraw: " + Math.abs(previousTransaction)); // If negative, print amount. Math.abs
		...
		void showMenu() {
			...
			do {
				...
				case 'B': // This case will prompt user for input on how much they would like to deposit
					...
					System.out.println("------------------------------------------------------------------");
					int amount = scn.nextInt(); // User scanner for amount
				...
				case 'C': // This will prompt user for input on how much they would like to withdraw
					...
					System.out.println("------------------------------------------------------------------");
					int amountTwo = scn.nextInt(); // User scanner for amount
